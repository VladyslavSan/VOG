...
EShLanguage
toEShLanguage(Shader::ShadingStage stage)
{
    switch (stage)
    {
...
compileGLSL(Shader::ShadingStage stage, const std::string& glslCode)
{
    static GlslangProcess sGlslangProcess;

    const auto shadingStage   = toEShLanguage(stage);
